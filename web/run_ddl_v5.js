...
const sqlPath = path.join(__dirname, 'tmp_fase3_rpc.sql');
...
async function run() {
    try {
        ...
        console.log('Creando Procedimiento Almacenado RPC... (Fase 3)');
        const res = await client.query(sqlText);
        console.log('Procedimiento almacenado creado con éxito.');
