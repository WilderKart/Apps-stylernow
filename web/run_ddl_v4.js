...
const sqlPath = path.join(__dirname, 'tmp_fase2_config_seed.sql');
...
async function run() {
    try {
        ...
        console.log('Sembrando configuraciones CMS (Fase 2)...');
        const res = await client.query(sqlText);
        console.log('Configuraciones sembradas con éxito.');
