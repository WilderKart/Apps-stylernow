...
const sqlPath = path.join(__dirname, 'tmp_fase5_reportes_cron.sql');
...
async function run() {
    try {
        ...
        console.log('Creando funciones de Reporte y Anomalías (Fase 5)...');
        const res = await client.query(sqlText);
        console.log('Funciones creadas con éxito.');
